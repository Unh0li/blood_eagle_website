...
<section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
  <div className="relative z-10 text-center max-w-5xl mx-auto">
    ...
    {/* Ljubljana - več mb da je daleč od naslova */}
    <p className="font-mono text-xs md:text-sm tracking-[0.5em] text-silver uppercase animate-[fadeUp_0.9s_ease_both] mb-16">
      Ljubljana · Slovenia
    </p>

    <div className="relative inline-block">
<h1 className="title-3d font-horror uppercase text-[10vw] md:text-[7.5vw] leading-[0.9] tracking-[0.08em]">
  BLOOD EAGLE
</h1>
</div>
    ...
    <p className="mt-10 font-mono text-xs md:text-sm text-silver uppercase tracking-[0.3em] leading-8 animate-[fadeUp_0.9s_ease_0.2s_both]">
      WELCOME TO VALHALLA
    </p>
